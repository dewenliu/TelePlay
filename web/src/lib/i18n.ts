...
const zh: Dict = {
  ...
  'browser.sortByName': '按名称',
  'browser.sortByDate': '按时间',
  'browser.sortBySize': '按大小',
  'browser.sortAsc': '升序',
  'browser.sortDesc': '降序',
...
const en: Dict = {
  ...
  'browser.sortByName': 'By Name',
  'browser.sortByDate': 'By Date',
  'browser.sortBySize': 'By Size',
  'browser.sortAsc': 'Ascending',
  'browser.sortDesc': 'Descending',
